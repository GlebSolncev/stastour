(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_module_catalog-section_js"],{
...
/***/ "./resources/js/module/catalog-section.js":
/*!************************************************!*\
  !*** ./resources/js/module/catalog-section.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _CatalogSection_brand = /*#__PURE__*/new WeakSet();
var CatalogSection = /*#__PURE__*/function () {
  function CatalogSection(container) {
    _classCallCheck(this, CatalogSection);
    _classPrivateMethodInitSpec(this, _CatalogSection_brand);
    ...
    value: function events() {
      ...
      this.scrollEvent = function (e) {
        ...
        if (window.scrollY >= breakline) {
          _assertClassBrand(_CatalogSection_brand, _this, _fetchNextPage).call(_this);
        }
      };
...
function _fetchNextPage() {
  ...
  this.lock = true;
  (0,_ajax_js__WEBPACK_IMPORTED_MODULE_1__.route)('catalog.page', {
    code: this.code,
    page: ++this.page
  }).then(function (response) {
    if (response) {
      var _refs = (0,_module_js__WEBPACK_IMPORTED_MODULE_0__.refs)(_this2.container),
        grid = _refs.grid;
