(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_module_blog-list_js"],{
...
/***/ "./resources/js/module/blog-list.js":
/*!******************************************!*\
  !*** ./resources/js/module/blog-list.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _module_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../module.js */ "./resources/js/module.js");
/* harmony import */ var _lib_dom_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../lib/dom.js */ "./resources/js/lib/dom.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var _BlogList_brand = /*#__PURE__*/new WeakSet();
var BlogList = /*#__PURE__*/function () {
  function BlogList(container) {
    _classCallCheck(this, BlogList);
    _classPrivateMethodInitSpec(this, _BlogList_brand);
    this.container = container;
    this.page = 1;
    this.events();
  }
  return _createClass(BlogList, [{
    key: "events",
    value: function events() {
      var _this = this;
      this.scrollEvent = function (e) {
        var rect = _this.container.getBoundingClientRect();
        var breakline = rect.top + rect.height - window.innerHeight;
        if (window.scrollY >= breakline) {
          _assertClassBrand(_BlogList_brand, _this, _fetchNextPage).call(_this);
        }
      };
...
function _fetchNextPage() {
  ...
  this.lock = true;
  (0,_ajax_js__WEBPACK_IMPORTED_MODULE_0__.route)('blog.page', {
    page: ++this.page
  }).then(function (response) {
    if (response) {
      var _refs = (0,_module_js__WEBPACK_IMPORTED_MODULE_1__.refs)(_this2.container),
        grid = _refs.grid;
      (0,_lib_dom_js__WEBPACK_IMPORTED_MODULE_2__.appendHtml)(grid, response);
    } else {
      window.removeEventListener('scroll', _this2.scrollEvent);
    }
  })["finally"](function () {
    _this2.lock = false;
  });
