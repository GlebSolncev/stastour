"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_ajax_checkout_confirm_js"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (data) {
  return new Promise(function (resolve, reject) {
    new _ajax_js__WEBPACK_IMPORTED_MODULE_0__.AjaxProcessor("/api/checkout/confirm/", data, 'POST').json().then(function (response) {
      resolve(response);
