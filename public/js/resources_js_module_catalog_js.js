(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_module_catalog_js"],{
...
/***/ "./resources/js/module/catalog.js":
/*!****************************************!*\
  !*** ./resources/js/module/catalog.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Catalog = /*#__PURE__*/function () {
  ...
  return _createClass(Catalog, [{
    key: "applyFilter",
    value: function applyFilter(filters) {
      var _this = this;
      (0,_ajax_js__WEBPACK_IMPORTED_MODULE_1__.route)('catalog.fetch', filters).then(function (response) {
        var sections = _this.container.querySelectorAll('[js-element="section"]');
        sections.forEach(function (section) {
          section.remove();
        });
        (0,_lib_dom_js__WEBPACK_IMPORTED_MODULE_2__.appendHtml)(_this.container, response);
      });
    }
  }]);
}();
