(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_module_discuss-form_js"],{
...
/***/ "./resources/js/module/discuss-form.js":
/*!*********************************************!*\
  !*** ./resources/js/module/discuss-form.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var DiscussForm = /*#__PURE__*/function () {
  function DiscussForm(element) {
    _classCallCheck(this, DiscussForm);
    this.element = element;
    this.init();
  }
  return _createClass(DiscussForm, [{
    key: "init",
    value: function init() {
    ...
    value: function submit() {
      ...
      return new Promise(function (resolve, reject) {
        if (!_this.element.checkValidity()) {
          _this.element.reportValidity();
          reject();
          return;
        }
        (0,_ajax_js__WEBPACK_IMPORTED_MODULE_1__.route)('discuss.confirm', new FormData(_this.element)).then(function (response) {
          if (response.done) {
            resolve();
          } else {
            reject();
