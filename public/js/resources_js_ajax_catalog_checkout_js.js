"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_ajax_catalog_checkout_js"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (id) {
  return new Promise(function (resolve, reject) {
    new _ajax_js__WEBPACK_IMPORTED_MODULE_0__.AjaxProcessor("/api/catalog/checkout/".concat(id, "/"), {}, 'GET').json().then(function (response) {
      resolve(response);
